...
PATH_MODEL_BASE = "../../Models/convnext-random-{}-run-{}.pt"
PATH_PREDICTIONS_BASE = "../../Predictions/convnext-random-{}-run-{}-{}.csv"
PATH_PLOT = "../../plots/convnext-random-{}-run-{}.pkl"
PATH_IMGS = "../../UTKFace"
...
class ConvNeXtTiny(nn.Module):
  def __init__(self):
    ...
    self.base.classifier[2] = nn.Linear(in_features=self.base.classifier[2].in_features, out_features=1)
